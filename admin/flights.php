                    ...
                    <tbody>
                        <?php while ($flight = mysqli_fetch_assoc($result)): ?>
                            <tr>
                                ...
                                <td><?= htmlspecialchars($flight['Boarding_time']) ?></td>
                                <td><?= htmlspecialchars($flight['Depart_time']) ?></td>
                                
                                <td><?= htmlspecialchars($flight['Flight_status']) ?></td>
                                <td><?= htmlspecialchars($flight['Price']) ?></td>
                                <td><?= htmlspecialchars($flight['Days_of_week']) ?></td>
                                  <td><?= htmlspecialchars($flight['Max_seat']) ?></td>
                                <td>
                                <a href="flight_edit.php?id=<?= urlencode($flight['Number']) ?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>

                                <a href="flight_delete.php?id=<?= urlencode($flight['Number']) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this flight?');"><i class="fas fa-trash-alt"></i></a>
