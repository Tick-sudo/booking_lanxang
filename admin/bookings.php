...
include '../db.php';
$sql = "SELECT b.Booking_id, b.Customer_id, b.Name, b.Lname, b.Id_plane, b.Fromm, b.Too, b.Depart_date, b.User_type, b.Price, b.Price_child, b.Price_infant,  b.Booking_date,  b.Booking_status, b.Tel,
               c.Id_card, c.Id_passport, c.Id_home
        FROM booking1 b
        LEFT JOIN customer1 c ON b.Customer_id = c.ID
                ...
                <table id="bookingTable" class="table table-striped table-bordered">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th>ນາມສະກຸນ</th>
                            <th>ເລກບັດປະຈຳຕົວ</th>
                            <th>ເລກໜັງສືເດີນທາງ</th>
                            <th>ເລກສຳມະໂນຄົວ</th>
                            <th>ລະຫັດຍົນ</th>
                            <th>ຕົ້ນທາງ</th>
                            <th>ປາຍທາງ</th>
                            <th>ວັນ/ເດືອນ/ປີ ເວລາເດີນທາງ</th>
                            <th>ປະເພດຜູ້ໂດຍສານ</th>
                            <th>ລາຄາຜູ້ໃຫຍ່</th>
                            <th>ລາຄາເດັກນ້ອຍ</th>
                            <th>ລາຄາເດັກແອນ້ອຍ</th>
                    ...
                    <tbody>
                        <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                            <tr>
                                ...
                                <td><?= htmlspecialchars($row['Price_child']) ?></td>
                                <td><?= htmlspecialchars($row['Price_infant']) ?></td>
