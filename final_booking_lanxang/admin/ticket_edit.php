...
if (isset($_POST['submit'])) {
    ...
    $update_sql = "UPDATE ticket1 SET Name=?, Lname=?, Fromm=?, Too=?, Flight=?, Seat=?, Boarding_time=? WHERE Ticket_id=?";
    $stmt_update = mysqli_prepare($conn, $update_sql);
    mysqli_stmt_bind_param($stmt_update, 'ssssssss', $name, $lname, $fromm, $too, $flight, $seat, $boarding_time, $ticket_id);
            ...
            <div class="card-body">
                <form method="POST" action="">
                    <div class="mb-3">
                        ...
                        <input type="text" id="ticket_id" class="form-control" value="<?= htmlspecialchars($ticket['Ticket_id']) ?>" disabled>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" name="boarding_time" id="boarding_time" class="form-control" required value="<?= date('Y-m-d\TH:i', strtotime($ticket['Boarding_time'])) ?>">
                    </div>
