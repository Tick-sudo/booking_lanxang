...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insert_sql = "INSERT INTO Flight1 (Id_plane, Fromm, Too, Depart_time, Price) 
                   VALUES ('$id_plane', '$fromm', '$too', '$depart_time', '$price')";
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            <form method="POST" action="flight_add.php">
                ...
                <div class="mb-3">
                    <label for="depart_time" class="form-label">ເວລາເດີນທາງ</label>
