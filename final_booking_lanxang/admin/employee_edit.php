...
<div class="content">
                       ...
                       <input type="text" id="ID" name="ID" class="form-control" required 
                          value="<?= htmlspecialchars($employee['ID']) ?>" 
                           ...
                           oninput="this.value = this.value.replace(/\D/g, '')" 
                              maxlength="11">
                    <div class="invalid-feedback">Please enter numeric ID only</div>
    ...
    value="<?= htmlspecialchars($employee['Lname']) ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="Gender" name="Gender" class="form-select" required>
                            ...
                            <option value="ຜູ້ຊາຍ" <?= $employee['Gender'] === 'Male' ? 'selected' : '' ?>>ຜູ້ຊາຍ</option>
                            <option value="ຜູ້ຍິງ" <?= $employee['Gender'] === 'Female' ? 'selected' : '' ?>>ຜູ້ຍິງ</option>
                        </select>
                        <div class="invalid-feedback">Please select Gender</div>
                    </div>
                    <div class="mb-3">
                        <label for="Date_of_birth" class="form-label">ວັນ,ເດືອນ,ປີ ເກີດ</label>
                        <input type="date" id="Date_of_birth" name="Date_of_birth" class="form-control" required value="<?= htmlspecialchars($employee['Date_of_birth']) ?>">
                        <div class="invalid-feedback">Please enter Date of Birth</div>
                    </div>
                    <div class="mb-3">
                        <label for="Address" class="form-label">ທີ່ຢູ່</label>
                        <input id="Address" name="Address" class="form-control" rows="3" required value=" <?= htmlspecialchars($employee['Address']) ?>" required maxlength="150" >
    ...
    value="<?= htmlspecialchars($employee['Education_background']) ?>">
                        ...
                        <div class="invalid-feedback">Please enter Education Background</div>
                    </div>
                    <div class="mb-3">
    ...
    value="<?= htmlspecialchars($employee['Email']) ?>">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="Tel" name="Tel" required maxlength="100"
