...
<div class="content">
    ...
    <li><strong>ປາຍທາງ:</strong> <?= htmlspecialchars($booking['Fromm']) ?></li>
    ...
    <?php if (!empty($booking['Depart_time'])): ?>
        <li><strong>ເວລາອອກເດີນທາງ:</strong> <?= htmlspecialchars($booking['Depart_time']) ?></li>
    <?php endif; ?>
    <?php if (!empty($booking['Booking_time'])): ?>
        <li><strong>ເວລາຈອງ:</strong> <?= htmlspecialchars($booking['Booking_time']) ?></li>
    <?php endif; ?>
</ul>
