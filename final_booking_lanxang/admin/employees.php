...
<!-- Main Content -->
<div class="content">
    <h2 class="mb-4">ພະນັກງານ</h2>

    <div class="card shadow-sm">
        <div class="card-header d-flex justify-content-between align-items-center bg-primary text-white">
            <h5 class="mb-0"><i class="fas fa-users"></i> ຂໍ້ມູນພະນັກງານ</h5>
                    ...
                    <tbody>
                        <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                            <tr>
                                ...
                                <td><?= $row['Tel'] ?></td>
                                <td>
                                    <a href="employee_edit.php?id=<?= $row['ID'] ?>" class="btn btn-primary btn-sm">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="employee_delete.php?id=<?= $row['ID'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')">
