...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO employees1 (ID, Name, Lname, Gender, Date_of_birth, Address, Education_background, Email, Tel)
            VALUES ('$id', '$name', '$lname', '$gender', '$dob', '$address', '$education', '$email', '$tel')";
...
<div class="content">
    ...
    <div class="mb-3">
        ...
        <textarea class="form-control" id="Address" name="Address" rows="3" required maxlength="150"></textarea>
    </div>
