...
<!-- Main Content -->
<div class="content">
    <h2 class="mb-4">ລູກຄ້າ</h2>

    <div class="card shadow-sm">
        <div class="card-header d-flex justify-content-between align-items-center bg-primary text-white">
            <h5 class="mb-0"><i class="fas fa-user"></i> ຂໍ້ມູນລູກຄ້າ</h5>
            <a href="customer_add.php" class="btn btn-light btn-sm">
                ...
                <table id="customerTable" class="table table-striped table-bordered">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th>ປະເທດ</th>
                            <th>ທີ່ຢູ່</th>
                            <th>ລະຫັດ ໜັງສືເດີນທາງ</th>
                            <th>ລະຫັດ ບັດປະຈຳຕົວ</th>
                            <th>ອີເມວ</th>
                            <th>ປະເພດຂອງປີ້</th>
                            <th>ເບີໂທລະສັບ</th>
                            <th>ຕົວເລືອກ</th>
                    ...
                    <tbody>
                        <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="customer_edit.php?id=<?= urlencode($row['ID']) ?>" class="btn btn-primary btn-sm">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="customer_delete.php?id=<?= urlencode($row['ID']) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')">
